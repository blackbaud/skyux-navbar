...
describe('Navbar', () => {
  ...
  it('should match previous navbar screenshot', (done) => {
    expect('#screenshot-navbar').toMatchBaselineScreenshot(done, {
  ...
  it('should match previous navbar screenshot when an item is active via the item CSS class', (done) => {
    expect('#screenshot-navbar-active-item').toMatchBaselineScreenshot(done, {
      screenshotName: 'navbar-item-active',
    });
  });

  it('should match previous navbar screenshot when an item is active via a child CSS class', (done) => {
    expect('#screenshot-navbar-active-child').toMatchBaselineScreenshot(done, {
